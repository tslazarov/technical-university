...
namespace Lipwig.Desktop.Statistics
{
    public class StatisticsViewModel : BindableBase
    {
        ...
        public StatisticsViewModel()
        {
            ...
            this.PopulateView(ViewBag.Email);
        ...
        private async void PopulateView(string email)
        {
            try
            {
                this.user = JsonConvert.DeserializeObject<User>(await HttpRequestHelper.GetUserByEmailRemote(email));
            }
            catch
            {
            }
